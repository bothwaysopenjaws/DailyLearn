...
namespace DailyLearn.WebApp.Controllers
{
    ...
    {
        private readonly DailyLearnWebAppDbContext _context;

        public QuestionsController(DailyLearnWebAppDbContext context)
        {
            _context = context;
        }
        ...
        {
            var dailyLearnWebAppDbContext = _context.Questions.Include(q => q.Topic);
            return View(await dailyLearnWebAppDbContext.ToListAsync());
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("QuestionToAsk,TopicId,Id")] Question question)
        {
            if (id != question.Id)
            {
                return NotFound();
